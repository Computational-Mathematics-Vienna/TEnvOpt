...
TESTparam = struct( ...
... % general variables
'userName','home/romana/OctaveWorkSpace','probCollect','bcp','prt',0, ...
 ... % noisy variables
...
'scaleProb','none','defaultSolList',false)
 ...
 if ~ TESTparam.defaultSolList 
     switch TESTparam.TypeVar
         case 0
         TESTparam.soList = {'BOBYQA'};
         case 1
            TESTparam.soList = {'MATRS'};
             TESTparam.soList = {'VRBBO'};               
         
         case 2
              TESTparam.soList = {'BFO'}     
     end

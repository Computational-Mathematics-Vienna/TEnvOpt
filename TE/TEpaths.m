...
% MEX           %
% WSOLdir       % 
PATHinit = ['/',username,'/TEnvOpt/TEprob/Collections'];  
switch probCollect
  case 'CUTEst'
...
SOLpath         = ['/',username,'/TEnvOpt/SOLVERS'];
RESpath         = ['/',username,'/TEnvOpt/RES/',probCollect];
HITpathinit     = ['/',username,'/TEnvOpt/HIT/'];  
HITpath         = [HITpathinit,probCollect];
PDFpath         = [RESpath,'/',probCollect,'/PDF'];
WORKpath        = ['/',username,'/TEnvOpt'];
WSOLdir         = ['/',username,'/TEnvOpt/WRAPPERS'];
WTUNEdir        = ['/',username,'/TEnvOpt/TUNERS'];
% check path info
ok=1;
